...
function Resume() {
	...
	return (
		<div className='resume'>
			...
			<h1>Donghyun Kim</h1>
			<h6><li>Location: Calgary / AB / T2M 1Y7</li></h6>
						...
						<Card.Body>
							<Table size="sm" striped bordered>
								...
								<tbody>
									...
									<tr>
										<th scope="row"><h6>• Knowledge of Object-Oriented Program: Java</h6></th>
									</tr>
									<tr>
										<th scope="row"><h6>• Knowledge of web programming languages: HTML, CSS, Java Script / React / NodeJS Express.</h6></th>
									</tr>
									<tr>
										<th scope="row"><h6>• Knowledge of  Relational Database: My SQL, SQL PLUS.</h6></th>
									</tr>
									<tr>
